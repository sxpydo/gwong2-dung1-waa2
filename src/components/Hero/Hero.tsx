...
const TRIP_DATE = new Date('2026-11-01T00:00:00');
  ...
  return (
    <div className={styles.hero}>
      ...
      <p className={styles.sub}>
        Built from your actual lessons with Bessie - real vocab, the grammar patterns you've covered,
        and the tone traps she flagged. Practice makes perfect!
      </p>
